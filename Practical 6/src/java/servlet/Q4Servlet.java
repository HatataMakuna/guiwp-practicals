...
public class Q4Servlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        // obtain parameters from the client page (html page)
        ...
        // Display the output
           ...
           out.println("Student Name   : <b>" + name + "</b><br/>");
           out.println("Level          : <b>" + level + "</b><br/>");
           out.println("Programme code : <b>" + programme + "</b><br/>");
           out.println("Year of Study  : <b>" + yr + "</b><br/>");
           out.println("<a href='PasstoCookie'>Click Here</a>");
           out.close();
        } catch (Exception ex) {
            throw ex;
        }
